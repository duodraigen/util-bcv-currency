import type { CurrencyValue } from '@/lib/types'
import axios from 'axios'
import { load as cheerioLoad } from 'cheerio'

import { BANKS_TABLE_URL, DEFAULT_USD_BANK_RVAL, REQ_AGENT, type SupportedBanks } from './config'
 ...
 */
export async function getBankUsdCurrencyPrices(bank: SupportedBanks): Promise<CurrencyValue> {
  try {
