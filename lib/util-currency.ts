import { EXTERNAL_SRC_URL, REQ_AGENT, type CurrencyKinds } from '@/lib/config'
 ...
 * @returns number | NaN
 */
export async function getCurrencyTableProperty(currency: CurrencyKinds): Promise<number> {
  try {
